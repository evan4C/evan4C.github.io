...
![cheatsheet](https://preview.redd.it/9eeanpxjucq21.png?width=1080&crop=smart&auto=webp&s=406b3aa497352336a81fca1d62182e168bcd2c04)
...
| 概念         | 描述                           |
| ------------ | ------------------------------ |
| 会话 Session | 最高层级容器（包含多个窗口）   |
| 窗口 Window  | 会话中的标签页（包含多个窗格） |
| 窗格 Pane    | 窗口中的分割区域               |
